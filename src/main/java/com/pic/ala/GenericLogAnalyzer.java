...
public class GenericLogAnalyzer extends LogBaseTopology {
	...
	public GenericLogAnalyzer(String configFileLocation) throws Exception {
...
//		String consumerGroupId = UUID.randomUUID().toString();
	...
	private void buildAndSubmit() throws AlreadyAliveException, InvalidTopologyException, AuthorizationException {
		...
		config.setMessageTimeoutSecs(600);	// This value(30 secs by default) must
							...
							/// KafkaSpout.
//		config.registerSerialization(klass);
...
//		LocalCluster cluster = new LocalCluster();
	...
	public static void main(String args[]) throws Exception {
		...
		GenericLogAnalyzer topology = new GenericLogAnalyzer(configFileLocation);
